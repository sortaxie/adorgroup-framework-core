package com.adorgroup.framework.core.security.user.token;



import com.adorgroup.framework.core.security.exception.BaseSecurityException;
...
public class EncryptedToken extends Token {
    ...
    public String toCipherString() {
        try {
            ...
            String tokenPlainText = uid + "|" +frnId+"|"+ phoneNumber + "|" + clientId + "|" + clientType.getCode() + "|" + createdTime;
